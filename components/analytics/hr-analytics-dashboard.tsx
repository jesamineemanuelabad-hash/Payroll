...
import {
  ...
  RefreshCw, SlidersHorizontal, Sparkles, UsersRound, WalletCards,
} from "lucide-react";
...
export function HrAnalyticsDashboard({ initialData }: { initialData: LiveDashboardData }) {
  ...
  return <div aria-busy={pending||scoring}>
    ...
    <p role="status" className="mt-3 text-xs text-slate-500">{scoring?"AI attendance analysis is running automatically…":scoringStatus||"AI attendance analysis checks for changes when you open this page."}</p>
